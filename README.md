...
**Errors:** `404` unit, pricing, or lease renewal not found · `409` date overlap on same unit · `422` validation failed (including renewal already completed, tenant mismatch, or invalid image)
