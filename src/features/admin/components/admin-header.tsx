  ...
  return (
    <header className="sticky top-0 z-40 border-b border-[#e3e2e0]/60 bg-white/70 backdrop-blur-xl">
      <div className="flex h-16 items-center gap-4 px-4 lg:px-8">
        ...
        <div className="relative ml-auto w-full max-w-md flex-1 sm:max-w-sm lg:max-w-md">
          <Icon
            name="search"
            size={20}
          ...
          <input
            ...
            className="h-10 w-full rounded-xl border border-[#e3e2e0] bg-[#faf9f6]/80 pl-10 pr-4 text-sm text-[#1a1c1a] outline-none transition-all placeholder:text-[#83746b]/70 focus:border-[#8b5e3c]/50 focus:bg-white focus:ring-2 focus:ring-[#8b5e3c]/15"
          />
        </div>
        ...
        <div className="flex shrink-0 items-center gap-1 sm:gap-2">
          ...
          >
            ...
            <span className="hidden text-left md:block">
              ...
              <span className="block text-xs text-[#83746b]">{th("roleManager")}</span>
            </span>
          </button>
        </div>
      </div>
